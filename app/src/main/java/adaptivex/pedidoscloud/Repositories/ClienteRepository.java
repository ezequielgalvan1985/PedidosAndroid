...
public class ClienteRepository
{
    ...
    public ClienteRepository abrir() throws SQLiteException
    {
    ...
    public ArrayList<ClienteEntity> parseCursorToArray(Cursor c) {
        try{
            ArrayList<ClienteEntity> al = new ArrayList<ClienteEntity>();
            while (c.moveToNext()) {
                ClienteEntity registro = new ClienteEntity();
    ...
    public long agregar(ClienteEntity item)
    {
    ...
    public void modificar(ClienteEntity item)
    {
    ...
    public void eliminar(ClienteEntity persona)
    {
        String[] argumentos = new String[]
